#!/bin/bash
#SBATCH --job-name=syri_Rab-R1
#SBATCH --output=/home/tbellagio/scratch/pang/sv_panel/syri/logs/syri_Rab-R1.%j.out
#SBATCH --error=/home/tbellagio/scratch/pang/sv_panel/syri/logs/syri_Rab-R1.%j.err
...
ASM=/home/tbellagio/scratch/pang/sv_panel/assemblies_clean/Rab-R1.fasta
BAM=/home/tbellagio/scratch/pang/sv_panel/alignment/alignments/Rab-R1/Rab-R1.tair10.bam
