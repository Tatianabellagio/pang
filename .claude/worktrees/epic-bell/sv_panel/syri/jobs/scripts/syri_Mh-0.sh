#!/bin/bash
#SBATCH --job-name=syri_Mh-0
#SBATCH --output=/home/tbellagio/scratch/pang/sv_panel/syri/logs/syri_Mh-0.%j.out
#SBATCH --error=/home/tbellagio/scratch/pang/sv_panel/syri/logs/syri_Mh-0.%j.err
...
ASM=/home/tbellagio/scratch/pang/sv_panel/assemblies_clean/Mh-0.fasta
BAM=/home/tbellagio/scratch/pang/sv_panel/alignment/alignments/Mh-0/Mh-0.tair10.bam
