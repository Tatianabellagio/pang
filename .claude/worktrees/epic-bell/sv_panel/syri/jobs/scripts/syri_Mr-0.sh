#!/bin/bash
#SBATCH --job-name=syri_Mr-0
#SBATCH --output=/home/tbellagio/scratch/pang/sv_panel/syri/logs/syri_Mr-0.%j.out
#SBATCH --error=/home/tbellagio/scratch/pang/sv_panel/syri/logs/syri_Mr-0.%j.err
...
ASM=/home/tbellagio/scratch/pang/sv_panel/assemblies_clean/Mr-0.fasta
BAM=/home/tbellagio/scratch/pang/sv_panel/alignment/alignments/Mr-0/Mr-0.tair10.bam
