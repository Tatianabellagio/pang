#!/bin/bash
#SBATCH --job-name=syri_Rld-2
#SBATCH --output=/home/tbellagio/scratch/pang/sv_panel/syri/logs/syri_Rld-2.%j.out
#SBATCH --error=/home/tbellagio/scratch/pang/sv_panel/syri/logs/syri_Rld-2.%j.err
...
ASM=/home/tbellagio/scratch/pang/sv_panel/assemblies_clean/Rld-2.fasta
BAM=/home/tbellagio/scratch/pang/sv_panel/alignment/alignments/Rld-2/Rld-2.tair10.bam
