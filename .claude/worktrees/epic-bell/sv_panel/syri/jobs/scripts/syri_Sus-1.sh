#!/bin/bash
#SBATCH --job-name=syri_Sus-1
#SBATCH --output=/home/tbellagio/scratch/pang/sv_panel/syri/logs/syri_Sus-1.%j.out
#SBATCH --error=/home/tbellagio/scratch/pang/sv_panel/syri/logs/syri_Sus-1.%j.err
...
ASM=/home/tbellagio/scratch/pang/sv_panel/assemblies_clean/Sus-1.fasta
BAM=/home/tbellagio/scratch/pang/sv_panel/alignment/alignments/Sus-1/Sus-1.tair10.bam
