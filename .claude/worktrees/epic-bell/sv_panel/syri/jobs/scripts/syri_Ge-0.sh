#!/bin/bash
#SBATCH --job-name=syri_Ge-0
#SBATCH --output=/home/tbellagio/scratch/pang/sv_panel/syri/logs/syri_Ge-0.%j.out
#SBATCH --error=/home/tbellagio/scratch/pang/sv_panel/syri/logs/syri_Ge-0.%j.err
...
ASM=/home/tbellagio/scratch/pang/sv_panel/assemblies_clean/Ge-0.fasta
BAM=/home/tbellagio/scratch/pang/sv_panel/alignment/alignments/Ge-0/Ge-0.tair10.bam
