#!/bin/bash
#SBATCH --job-name=syri_Cant-1
#SBATCH --output=/home/tbellagio/scratch/pang/sv_panel/syri/logs/syri_Cant-1.%j.out
#SBATCH --error=/home/tbellagio/scratch/pang/sv_panel/syri/logs/syri_Cant-1.%j.err
...
ASM=/home/tbellagio/scratch/pang/sv_panel/assemblies_clean/Cant-1.fasta
BAM=/home/tbellagio/scratch/pang/sv_panel/alignment/alignments/Cant-1/Cant-1.tair10.bam
