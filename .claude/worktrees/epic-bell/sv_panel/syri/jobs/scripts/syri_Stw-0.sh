#!/bin/bash
#SBATCH --job-name=syri_Stw-0
#SBATCH --output=/home/tbellagio/scratch/pang/sv_panel/syri/logs/syri_Stw-0.%j.out
#SBATCH --error=/home/tbellagio/scratch/pang/sv_panel/syri/logs/syri_Stw-0.%j.err
...
ASM=/home/tbellagio/scratch/pang/sv_panel/assemblies_clean/Stw-0.fasta
BAM=/home/tbellagio/scratch/pang/sv_panel/alignment/alignments/Stw-0/Stw-0.tair10.bam
