#!/bin/bash
#SBATCH --job-name=syri_Bla-1
#SBATCH --output=/home/tbellagio/scratch/pang/sv_panel/syri/logs/syri_Bla-1.%j.out
#SBATCH --error=/home/tbellagio/scratch/pang/sv_panel/syri/logs/syri_Bla-1.%j.err
...
ASM=/home/tbellagio/scratch/pang/sv_panel/assemblies_clean/Bla-1.fasta
BAM=/home/tbellagio/scratch/pang/sv_panel/alignment/alignments/Bla-1/Bla-1.tair10.bam
