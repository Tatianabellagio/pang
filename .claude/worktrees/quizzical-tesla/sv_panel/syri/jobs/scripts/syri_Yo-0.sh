#!/bin/bash
#SBATCH --job-name=syri_Yo-0
#SBATCH --output=/home/tbellagio/scratch/pang/sv_panel/syri/logs/syri_Yo-0.%j.out
#SBATCH --error=/home/tbellagio/scratch/pang/sv_panel/syri/logs/syri_Yo-0.%j.err
...
ASM=/home/tbellagio/scratch/pang/sv_panel/assemblies_clean/Yo-0.fasta
BAM=/home/tbellagio/scratch/pang/sv_panel/alignment/alignments/Yo-0/Yo-0.tair10.bam
