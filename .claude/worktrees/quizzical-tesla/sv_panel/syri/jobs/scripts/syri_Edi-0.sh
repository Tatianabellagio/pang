#!/bin/bash
#SBATCH --job-name=syri_Edi-0
#SBATCH --output=/home/tbellagio/scratch/pang/sv_panel/syri/logs/syri_Edi-0.%j.out
#SBATCH --error=/home/tbellagio/scratch/pang/sv_panel/syri/logs/syri_Edi-0.%j.err
...
ASM=/home/tbellagio/scratch/pang/sv_panel/assemblies_clean/Edi-0.fasta
BAM=/home/tbellagio/scratch/pang/sv_panel/alignment/alignments/Edi-0/Edi-0.tair10.bam
