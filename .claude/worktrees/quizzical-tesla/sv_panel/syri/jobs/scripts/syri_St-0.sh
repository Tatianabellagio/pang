#!/bin/bash
#SBATCH --job-name=syri_St-0
#SBATCH --output=/home/tbellagio/scratch/pang/sv_panel/syri/logs/syri_St-0.%j.out
#SBATCH --error=/home/tbellagio/scratch/pang/sv_panel/syri/logs/syri_St-0.%j.err
...
ASM=/home/tbellagio/scratch/pang/sv_panel/assemblies_clean/St-0.fasta
BAM=/home/tbellagio/scratch/pang/sv_panel/alignment/alignments/St-0/St-0.tair10.bam
