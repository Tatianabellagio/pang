#!/bin/bash
#SBATCH --job-name=syri_Jea
#SBATCH --output=/home/tbellagio/scratch/pang/sv_panel/syri/logs/syri_Jea.%j.out
#SBATCH --error=/home/tbellagio/scratch/pang/sv_panel/syri/logs/syri_Jea.%j.err
...
ASM=/home/tbellagio/scratch/pang/sv_panel/assemblies_clean/Jea.fasta
BAM=/home/tbellagio/scratch/pang/sv_panel/alignment/alignments/Jea/Jea.tair10.bam
