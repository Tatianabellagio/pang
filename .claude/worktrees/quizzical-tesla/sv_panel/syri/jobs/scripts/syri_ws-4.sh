#!/bin/bash
#SBATCH --job-name=syri_ws-4
#SBATCH --output=/home/tbellagio/scratch/pang/sv_panel/syri/logs/syri_ws-4.%j.out
#SBATCH --error=/home/tbellagio/scratch/pang/sv_panel/syri/logs/syri_ws-4.%j.err
...
ASM=/home/tbellagio/scratch/pang/sv_panel/assemblies_clean/ws-4.fasta
BAM=/home/tbellagio/scratch/pang/sv_panel/alignment/alignments/ws-4/ws-4.tair10.bam
