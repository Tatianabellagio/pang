#!/bin/bash
#SBATCH --job-name=syri_Oy-0
#SBATCH --output=/home/tbellagio/scratch/pang/sv_panel/syri/logs/syri_Oy-0.%j.out
#SBATCH --error=/home/tbellagio/scratch/pang/sv_panel/syri/logs/syri_Oy-0.%j.err
...
ASM=/home/tbellagio/scratch/pang/sv_panel/assemblies_clean/Oy-0.fasta
BAM=/home/tbellagio/scratch/pang/sv_panel/alignment/alignments/Oy-0/Oy-0.tair10.bam
