#!/bin/bash
#SBATCH --job-name=syri_N13
#SBATCH --output=/home/tbellagio/scratch/pang/sv_panel/syri/logs/syri_N13.%j.out
#SBATCH --error=/home/tbellagio/scratch/pang/sv_panel/syri/logs/syri_N13.%j.err
...
ASM=/home/tbellagio/scratch/pang/sv_panel/assemblies_clean/N13.fasta
BAM=/home/tbellagio/scratch/pang/sv_panel/alignment/alignments/N13/N13.tair10.bam
