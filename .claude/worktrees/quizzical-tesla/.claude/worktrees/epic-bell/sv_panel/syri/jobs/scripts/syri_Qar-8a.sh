#!/bin/bash
#SBATCH --job-name=syri_Qar-8a
#SBATCH --output=/home/tbellagio/scratch/pang/sv_panel/syri/logs/syri_Qar-8a.%j.out
#SBATCH --error=/home/tbellagio/scratch/pang/sv_panel/syri/logs/syri_Qar-8a.%j.err
...
ASM=/home/tbellagio/scratch/pang/sv_panel/assemblies_clean/Qar-8a.fasta
BAM=/home/tbellagio/scratch/pang/sv_panel/alignment/alignments/Qar-8a/Qar-8a.tair10.bam
