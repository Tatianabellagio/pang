#!/bin/bash
#SBATCH --job-name=syri_Sf-2
#SBATCH --output=/home/tbellagio/scratch/pang/sv_panel/syri/logs/syri_Sf-2.%j.out
#SBATCH --error=/home/tbellagio/scratch/pang/sv_panel/syri/logs/syri_Sf-2.%j.err
...
ASM=/home/tbellagio/scratch/pang/sv_panel/assemblies_clean/Sf-2.fasta
BAM=/home/tbellagio/scratch/pang/sv_panel/alignment/alignments/Sf-2/Sf-2.tair10.bam
