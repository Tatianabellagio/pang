#!/bin/bash
#SBATCH --job-name=syri_Kz-9
#SBATCH --output=/home/tbellagio/scratch/pang/sv_panel/syri/logs/syri_Kz-9.%j.out
#SBATCH --error=/home/tbellagio/scratch/pang/sv_panel/syri/logs/syri_Kz-9.%j.err
...
ASM=/home/tbellagio/scratch/pang/sv_panel/assemblies_clean/Kz-9.fasta
BAM=/home/tbellagio/scratch/pang/sv_panel/alignment/alignments/Kz-9/Kz-9.tair10.bam
