#!/bin/bash
#SBATCH --job-name=syri_Hiroshima
#SBATCH --output=/home/tbellagio/scratch/pang/sv_panel/syri/logs/syri_Hiroshima.%j.out
#SBATCH --error=/home/tbellagio/scratch/pang/sv_panel/syri/logs/syri_Hiroshima.%j.err
...
ASM=/home/tbellagio/scratch/pang/sv_panel/assemblies_clean/Hiroshima.fasta
BAM=/home/tbellagio/scratch/pang/sv_panel/alignment/alignments/Hiroshima/Hiroshima.tair10.bam
