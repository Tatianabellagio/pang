#!/bin/bash
#SBATCH --job-name=syri_Zal-1
#SBATCH --output=/home/tbellagio/scratch/pang/sv_panel/syri/logs/syri_Zal-1.%j.out
#SBATCH --error=/home/tbellagio/scratch/pang/sv_panel/syri/logs/syri_Zal-1.%j.err
...
ASM=/home/tbellagio/scratch/pang/sv_panel/assemblies_clean/Zal-1.fasta
BAM=/home/tbellagio/scratch/pang/sv_panel/alignment/alignments/Zal-1/Zal-1.tair10.bam
