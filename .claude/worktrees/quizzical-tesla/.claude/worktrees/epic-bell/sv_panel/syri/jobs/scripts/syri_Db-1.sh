#!/bin/bash
#SBATCH --job-name=syri_Db-1
#SBATCH --output=/home/tbellagio/scratch/pang/sv_panel/syri/logs/syri_Db-1.%j.out
#SBATCH --error=/home/tbellagio/scratch/pang/sv_panel/syri/logs/syri_Db-1.%j.err
...
ASM=/home/tbellagio/scratch/pang/sv_panel/assemblies_clean/Db-1.fasta
BAM=/home/tbellagio/scratch/pang/sv_panel/alignment/alignments/Db-1/Db-1.tair10.bam
