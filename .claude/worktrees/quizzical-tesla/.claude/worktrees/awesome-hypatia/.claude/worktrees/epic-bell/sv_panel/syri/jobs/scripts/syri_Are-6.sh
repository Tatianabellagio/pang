#!/bin/bash
#SBATCH --job-name=syri_Are-6
#SBATCH --output=/home/tbellagio/scratch/pang/sv_panel/syri/logs/syri_Are-6.%j.out
#SBATCH --error=/home/tbellagio/scratch/pang/sv_panel/syri/logs/syri_Are-6.%j.err
...
ASM=/home/tbellagio/scratch/pang/sv_panel/assemblies_clean/Are-6.fasta
BAM=/home/tbellagio/scratch/pang/sv_panel/alignment/alignments/Are-6/Are-6.tair10.bam
