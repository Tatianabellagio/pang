#!/bin/bash
#SBATCH --job-name=syri_Est-0
#SBATCH --output=/home/tbellagio/scratch/pang/sv_panel/syri/logs/syri_Est-0.%j.out
#SBATCH --error=/home/tbellagio/scratch/pang/sv_panel/syri/logs/syri_Est-0.%j.err
...
ASM=/home/tbellagio/scratch/pang/sv_panel/assemblies_clean/Est-0.fasta
BAM=/home/tbellagio/scratch/pang/sv_panel/alignment/alignments/Est-0/Est-0.tair10.bam
