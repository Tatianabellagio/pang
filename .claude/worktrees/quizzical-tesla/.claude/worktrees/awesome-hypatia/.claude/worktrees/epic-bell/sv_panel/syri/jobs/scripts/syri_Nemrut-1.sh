#!/bin/bash
#SBATCH --job-name=syri_Nemrut-1
#SBATCH --output=/home/tbellagio/scratch/pang/sv_panel/syri/logs/syri_Nemrut-1.%j.out
#SBATCH --error=/home/tbellagio/scratch/pang/sv_panel/syri/logs/syri_Nemrut-1.%j.err
...
BAM=/home/tbellagio/scratch/pang/sv_panel/alignment/alignments/Nemrut-1/Nemrut-1.tair10.bam
