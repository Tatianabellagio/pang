#!/bin/bash
#SBATCH --job-name=syri_Pa-1
#SBATCH --output=/home/tbellagio/scratch/pang/sv_panel/syri/logs/syri_Pa-1.%j.out
#SBATCH --error=/home/tbellagio/scratch/pang/sv_panel/syri/logs/syri_Pa-1.%j.err
...
ASM=/home/tbellagio/scratch/pang/sv_panel/assemblies_clean/Pa-1.fasta
BAM=/home/tbellagio/scratch/pang/sv_panel/alignment/alignments/Pa-1/Pa-1.tair10.bam
