#!/bin/bash
#SBATCH --job-name=syri_Lu-1
#SBATCH --output=/home/tbellagio/scratch/pang/sv_panel/syri/logs/syri_Lu-1.%j.out
#SBATCH --error=/home/tbellagio/scratch/pang/sv_panel/syri/logs/syri_Lu-1.%j.err
...
ASM=/home/tbellagio/scratch/pang/sv_panel/assemblies_clean/Lu-1.fasta
BAM=/home/tbellagio/scratch/pang/sv_panel/alignment/alignments/Lu-1/Lu-1.tair10.bam
