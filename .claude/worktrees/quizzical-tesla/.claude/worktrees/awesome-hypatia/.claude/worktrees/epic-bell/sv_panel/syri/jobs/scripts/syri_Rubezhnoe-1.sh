#!/bin/bash
#SBATCH --job-name=syri_Rubezhnoe-1
#SBATCH --output=/home/tbellagio/scratch/pang/sv_panel/syri/logs/syri_Rubezhnoe-1.%j.out
#SBATCH --error=/home/tbellagio/scratch/pang/sv_panel/syri/logs/syri_Rubezhnoe-1.%j.err
...
ASM=/home/tbellagio/scratch/pang/sv_panel/assemblies_clean/Rubezhnoe-1.fasta
BAM=/home/tbellagio/scratch/pang/sv_panel/alignment/alignments/Rubezhnoe-1/Rubezhnoe-1.tair10.bam
