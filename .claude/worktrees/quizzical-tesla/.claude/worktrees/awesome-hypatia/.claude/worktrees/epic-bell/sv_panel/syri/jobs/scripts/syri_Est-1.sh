#!/bin/bash
#SBATCH --job-name=syri_Est-1
#SBATCH --output=/home/tbellagio/scratch/pang/sv_panel/syri/logs/syri_Est-1.%j.out
#SBATCH --error=/home/tbellagio/scratch/pang/sv_panel/syri/logs/syri_Est-1.%j.err
...
ASM=/home/tbellagio/scratch/pang/sv_panel/assemblies_clean/Est-1.fasta
BAM=/home/tbellagio/scratch/pang/sv_panel/alignment/alignments/Est-1/Est-1.tair10.bam
