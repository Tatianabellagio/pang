#!/bin/bash
#SBATCH --job-name=syri_Kyr-1
#SBATCH --output=/home/tbellagio/scratch/pang/sv_panel/syri/logs/syri_Kyr-1.%j.out
#SBATCH --error=/home/tbellagio/scratch/pang/sv_panel/syri/logs/syri_Kyr-1.%j.err
...
ASM=/home/tbellagio/scratch/pang/sv_panel/assemblies_clean/Kyr-1.fasta
BAM=/home/tbellagio/scratch/pang/sv_panel/alignment/alignments/Kyr-1/Kyr-1.tair10.bam
