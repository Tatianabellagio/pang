...
READS_DIR=${WORK}/data/reads/freq_1kb_050
COUNTS_BY_ALLELE=${WORK}/results/freq_1kb_050.counts_by_allele.k${K}.tsv
RAW_COUNTS=${WORK}/results/freq_1kb_050.raw_kmer_counts.k${K}.tsv
AF_OUT=${WORK}/results/freq_1kb_050.allele_frequencies.k${K}.tsv

mkdir -p ${WORK}/results

# Combine r1 + r2 into single fastq (freqk doesn't care about pairing)
READS_COMBINED=${WORK}/data/reads/freq_1kb_050/all.fq
