#!/bin/bash
#SBATCH --job-name=syri_Col-0
#SBATCH --output=/home/tbellagio/scratch/pang/sv_panel/syri/logs/syri_Col-0.%j.out
#SBATCH --error=/home/tbellagio/scratch/pang/sv_panel/syri/logs/syri_Col-0.%j.err
...
ASM=/home/tbellagio/scratch/pang/sv_panel/assemblies_clean/Col-0.fasta
BAM=/home/tbellagio/scratch/pang/sv_panel/alignment/alignments/Col-0/Col-0.tair10.bam
