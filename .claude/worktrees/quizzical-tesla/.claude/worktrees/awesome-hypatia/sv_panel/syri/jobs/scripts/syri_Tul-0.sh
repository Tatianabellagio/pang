#!/bin/bash
#SBATCH --job-name=syri_Tul-0
#SBATCH --output=/home/tbellagio/scratch/pang/sv_panel/syri/logs/syri_Tul-0.%j.out
#SBATCH --error=/home/tbellagio/scratch/pang/sv_panel/syri/logs/syri_Tul-0.%j.err
...
ASM=/home/tbellagio/scratch/pang/sv_panel/assemblies_clean/Tul-0.fasta
BAM=/home/tbellagio/scratch/pang/sv_panel/alignment/alignments/Tul-0/Tul-0.tair10.bam
