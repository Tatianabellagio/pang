#!/bin/bash
#SBATCH --job-name=syri_Ice-1
#SBATCH --output=/home/tbellagio/scratch/pang/sv_panel/syri/logs/syri_Ice-1.%j.out
#SBATCH --error=/home/tbellagio/scratch/pang/sv_panel/syri/logs/syri_Ice-1.%j.err
...
ASM=/home/tbellagio/scratch/pang/sv_panel/assemblies_clean/Ice-1.fasta
BAM=/home/tbellagio/scratch/pang/sv_panel/alignment/alignments/Ice-1/Ice-1.tair10.bam
