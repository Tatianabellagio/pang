#!/bin/bash
#SBATCH --job-name=syri_Are-10
#SBATCH --output=/home/tbellagio/scratch/pang/sv_panel/syri/logs/syri_Are-10.%j.out
#SBATCH --error=/home/tbellagio/scratch/pang/sv_panel/syri/logs/syri_Are-10.%j.err
...
ASM=/home/tbellagio/scratch/pang/sv_panel/assemblies_clean/Are-10.fasta
BAM=/home/tbellagio/scratch/pang/sv_panel/alignment/alignments/Are-10/Are-10.tair10.bam
