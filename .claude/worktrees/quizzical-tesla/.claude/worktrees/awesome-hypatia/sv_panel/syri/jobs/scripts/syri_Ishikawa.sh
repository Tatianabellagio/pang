#!/bin/bash
#SBATCH --job-name=syri_Ishikawa
#SBATCH --output=/home/tbellagio/scratch/pang/sv_panel/syri/logs/syri_Ishikawa.%j.out
#SBATCH --error=/home/tbellagio/scratch/pang/sv_panel/syri/logs/syri_Ishikawa.%j.err
...
ASM=/home/tbellagio/scratch/pang/sv_panel/assemblies_clean/Ishikawa.fasta
BAM=/home/tbellagio/scratch/pang/sv_panel/alignment/alignments/Ishikawa/Ishikawa.tair10.bam
