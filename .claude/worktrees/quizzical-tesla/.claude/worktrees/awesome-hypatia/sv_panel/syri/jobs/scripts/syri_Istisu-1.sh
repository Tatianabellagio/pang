#!/bin/bash
#SBATCH --job-name=syri_Istisu-1
#SBATCH --output=/home/tbellagio/scratch/pang/sv_panel/syri/logs/syri_Istisu-1.%j.out
#SBATCH --error=/home/tbellagio/scratch/pang/sv_panel/syri/logs/syri_Istisu-1.%j.err
...
ASM=/home/tbellagio/scratch/pang/sv_panel/assemblies_clean/Istisu-1.fasta
BAM=/home/tbellagio/scratch/pang/sv_panel/alignment/alignments/Istisu-1/Istisu-1.tair10.bam
