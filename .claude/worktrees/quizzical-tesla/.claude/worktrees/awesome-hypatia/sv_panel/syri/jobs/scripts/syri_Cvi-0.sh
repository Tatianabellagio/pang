#!/bin/bash
#SBATCH --job-name=syri_Cvi-0
#SBATCH --output=/home/tbellagio/scratch/pang/sv_panel/syri/logs/syri_Cvi-0.%j.out
#SBATCH --error=/home/tbellagio/scratch/pang/sv_panel/syri/logs/syri_Cvi-0.%j.err
...
ASM=/home/tbellagio/scratch/pang/sv_panel/assemblies_clean/Cvi-0.fasta
BAM=/home/tbellagio/scratch/pang/sv_panel/alignment/alignments/Cvi-0/Cvi-0.tair10.bam
