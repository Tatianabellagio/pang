#!/bin/bash
#SBATCH --job-name=syri_Had-6b
#SBATCH --output=/home/tbellagio/scratch/pang/sv_panel/syri/logs/syri_Had-6b.%j.out
#SBATCH --error=/home/tbellagio/scratch/pang/sv_panel/syri/logs/syri_Had-6b.%j.err
...
ASM=/home/tbellagio/scratch/pang/sv_panel/assemblies_clean/Had-6b.fasta
BAM=/home/tbellagio/scratch/pang/sv_panel/alignment/alignments/Had-6b/Had-6b.tair10.bam
