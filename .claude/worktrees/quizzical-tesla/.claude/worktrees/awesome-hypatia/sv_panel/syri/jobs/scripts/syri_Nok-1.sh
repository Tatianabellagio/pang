#!/bin/bash
#SBATCH --job-name=syri_Nok-1
#SBATCH --output=/home/tbellagio/scratch/pang/sv_panel/syri/logs/syri_Nok-1.%j.out
#SBATCH --error=/home/tbellagio/scratch/pang/sv_panel/syri/logs/syri_Nok-1.%j.err
...
ASM=/home/tbellagio/scratch/pang/sv_panel/assemblies_clean/Nok-1.fasta
BAM=/home/tbellagio/scratch/pang/sv_panel/alignment/alignments/Nok-1/Nok-1.tair10.bam
