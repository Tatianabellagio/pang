#!/bin/bash
#SBATCH --job-name=syri_Taz-0
#SBATCH --output=/home/tbellagio/scratch/pang/sv_panel/syri/logs/syri_Taz-0.%j.out
#SBATCH --error=/home/tbellagio/scratch/pang/sv_panel/syri/logs/syri_Taz-0.%j.err
...
ASM=/home/tbellagio/scratch/pang/sv_panel/assemblies_clean/Taz-0.fasta
BAM=/home/tbellagio/scratch/pang/sv_panel/alignment/alignments/Taz-0/Taz-0.tair10.bam
