#!/bin/bash
#SBATCH --job-name=syri_Are-1
#SBATCH --output=/home/tbellagio/scratch/pang/sv_panel/syri/logs/syri_Are-1.%j.out
#SBATCH --error=/home/tbellagio/scratch/pang/sv_panel/syri/logs/syri_Are-1.%j.err
...
ASM=/home/tbellagio/scratch/pang/sv_panel/assemblies_clean/Are-1.fasta
BAM=/home/tbellagio/scratch/pang/sv_panel/alignment/alignments/Are-1/Are-1.tair10.bam
