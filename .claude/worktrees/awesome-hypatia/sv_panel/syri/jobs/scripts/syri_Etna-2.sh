#!/bin/bash
#SBATCH --job-name=syri_Etna-2
#SBATCH --output=/home/tbellagio/scratch/pang/sv_panel/syri/logs/syri_Etna-2.%j.out
#SBATCH --error=/home/tbellagio/scratch/pang/sv_panel/syri/logs/syri_Etna-2.%j.err
...
ASM=/home/tbellagio/scratch/pang/sv_panel/assemblies_clean/Etna-2.fasta
BAM=/home/tbellagio/scratch/pang/sv_panel/alignment/alignments/Etna-2/Etna-2.tair10.bam
