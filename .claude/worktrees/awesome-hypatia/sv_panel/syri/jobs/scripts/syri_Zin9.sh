#!/bin/bash
#SBATCH --job-name=syri_Zin9
#SBATCH --output=/home/tbellagio/scratch/pang/sv_panel/syri/logs/syri_Zin9.%j.out
#SBATCH --error=/home/tbellagio/scratch/pang/sv_panel/syri/logs/syri_Zin9.%j.err
...
ASM=/home/tbellagio/scratch/pang/sv_panel/assemblies_clean/Zin9.fasta
BAM=/home/tbellagio/scratch/pang/sv_panel/alignment/alignments/Zin9/Zin9.tair10.bam
