#!/bin/bash
#SBATCH --job-name=syri_Ri-0
#SBATCH --output=/home/tbellagio/scratch/pang/sv_panel/syri/logs/syri_Ri-0.%j.out
#SBATCH --error=/home/tbellagio/scratch/pang/sv_panel/syri/logs/syri_Ri-0.%j.err
...
ASM=/home/tbellagio/scratch/pang/sv_panel/assemblies_clean/Ri-0.fasta
BAM=/home/tbellagio/scratch/pang/sv_panel/alignment/alignments/Ri-0/Ri-0.tair10.bam
