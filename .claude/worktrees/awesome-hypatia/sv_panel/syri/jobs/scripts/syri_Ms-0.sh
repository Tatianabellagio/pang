#!/bin/bash
#SBATCH --job-name=syri_Ms-0
#SBATCH --output=/home/tbellagio/scratch/pang/sv_panel/syri/logs/syri_Ms-0.%j.out
#SBATCH --error=/home/tbellagio/scratch/pang/sv_panel/syri/logs/syri_Ms-0.%j.err
...
ASM=/home/tbellagio/scratch/pang/sv_panel/assemblies_clean/Ms-0.fasta
BAM=/home/tbellagio/scratch/pang/sv_panel/alignment/alignments/Ms-0/Ms-0.tair10.bam
