#!/bin/bash
#SBATCH --job-name=syri_Kas-1
#SBATCH --output=/home/tbellagio/scratch/pang/sv_panel/syri/logs/syri_Kas-1.%j.out
#SBATCH --error=/home/tbellagio/scratch/pang/sv_panel/syri/logs/syri_Kas-1.%j.err
...
ASM=/home/tbellagio/scratch/pang/sv_panel/assemblies_clean/Kas-1.fasta
BAM=/home/tbellagio/scratch/pang/sv_panel/alignment/alignments/Kas-1/Kas-1.tair10.bam
