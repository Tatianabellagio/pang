#!/bin/bash
#SBATCH --job-name=syri_Ct-1
#SBATCH --output=/home/tbellagio/scratch/pang/sv_panel/syri/logs/syri_Ct-1.%j.out
#SBATCH --error=/home/tbellagio/scratch/pang/sv_panel/syri/logs/syri_Ct-1.%j.err
...
ASM=/home/tbellagio/scratch/pang/sv_panel/assemblies_clean/Ct-1.fasta
BAM=/home/tbellagio/scratch/pang/sv_panel/alignment/alignments/Ct-1/Ct-1.tair10.bam
