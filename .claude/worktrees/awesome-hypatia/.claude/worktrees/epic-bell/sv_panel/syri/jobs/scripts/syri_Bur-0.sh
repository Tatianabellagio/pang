#!/bin/bash
#SBATCH --job-name=syri_Bur-0
#SBATCH --output=/home/tbellagio/scratch/pang/sv_panel/syri/logs/syri_Bur-0.%j.out
#SBATCH --error=/home/tbellagio/scratch/pang/sv_panel/syri/logs/syri_Bur-0.%j.err
...
ASM=/home/tbellagio/scratch/pang/sv_panel/assemblies_clean/Bur-0.fasta
BAM=/home/tbellagio/scratch/pang/sv_panel/alignment/alignments/Bur-0/Bur-0.tair10.bam
