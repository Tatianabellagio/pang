#!/bin/bash
#SBATCH --job-name=syri_RRS10
#SBATCH --output=/home/tbellagio/scratch/pang/sv_panel/syri/logs/syri_RRS10.%j.out
#SBATCH --error=/home/tbellagio/scratch/pang/sv_panel/syri/logs/syri_RRS10.%j.err
...
ASM=/home/tbellagio/scratch/pang/sv_panel/assemblies_clean/RRS10.fasta
BAM=/home/tbellagio/scratch/pang/sv_panel/alignment/alignments/RRS10/RRS10.tair10.bam
