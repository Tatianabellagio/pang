#!/bin/bash
#SBATCH --job-name=syri_Are-2
#SBATCH --output=/home/tbellagio/scratch/pang/sv_panel/syri/logs/syri_Are-2.%j.out
#SBATCH --error=/home/tbellagio/scratch/pang/sv_panel/syri/logs/syri_Are-2.%j.err
...
ASM=/home/tbellagio/scratch/pang/sv_panel/assemblies_clean/Are-2.fasta
BAM=/home/tbellagio/scratch/pang/sv_panel/alignment/alignments/Are-2/Are-2.tair10.bam
