#!/bin/bash
#SBATCH --job-name=syri_Tsu-0
#SBATCH --output=/home/tbellagio/scratch/pang/sv_panel/syri/logs/syri_Tsu-0.%j.out
#SBATCH --error=/home/tbellagio/scratch/pang/sv_panel/syri/logs/syri_Tsu-0.%j.err
...
ASM=/home/tbellagio/scratch/pang/sv_panel/assemblies_clean/Tsu-0.fasta
BAM=/home/tbellagio/scratch/pang/sv_panel/alignment/alignments/Tsu-0/Tsu-0.tair10.bam
