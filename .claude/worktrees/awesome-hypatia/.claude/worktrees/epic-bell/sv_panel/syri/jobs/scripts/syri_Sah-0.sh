#!/bin/bash
#SBATCH --job-name=syri_Sah-0
#SBATCH --output=/home/tbellagio/scratch/pang/sv_panel/syri/logs/syri_Sah-0.%j.out
#SBATCH --error=/home/tbellagio/scratch/pang/sv_panel/syri/logs/syri_Sah-0.%j.err
...
ASM=/home/tbellagio/scratch/pang/sv_panel/assemblies_clean/Sah-0.fasta
BAM=/home/tbellagio/scratch/pang/sv_panel/alignment/alignments/Sah-0/Sah-0.tair10.bam
