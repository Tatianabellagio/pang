#!/bin/bash
#SBATCH --job-name=syri_Shigu-2
#SBATCH --output=/home/tbellagio/scratch/pang/sv_panel/syri/logs/syri_Shigu-2.%j.out
#SBATCH --error=/home/tbellagio/scratch/pang/sv_panel/syri/logs/syri_Shigu-2.%j.err
...
ASM=/home/tbellagio/scratch/pang/sv_panel/assemblies_clean/Shigu-2.fasta
BAM=/home/tbellagio/scratch/pang/sv_panel/alignment/alignments/Shigu-2/Shigu-2.tair10.bam
