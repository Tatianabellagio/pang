#!/bin/bash
#SBATCH --job-name=syri_Ita-0
#SBATCH --output=/home/tbellagio/scratch/pang/sv_panel/syri/logs/syri_Ita-0.%j.out
#SBATCH --error=/home/tbellagio/scratch/pang/sv_panel/syri/logs/syri_Ita-0.%j.err
...
ASM=/home/tbellagio/scratch/pang/sv_panel/assemblies_clean/Ita-0.fasta
BAM=/home/tbellagio/scratch/pang/sv_panel/alignment/alignments/Ita-0/Ita-0.tair10.bam
