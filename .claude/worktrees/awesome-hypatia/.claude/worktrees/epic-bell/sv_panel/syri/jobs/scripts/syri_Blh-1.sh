#!/bin/bash
#SBATCH --job-name=syri_Blh-1
#SBATCH --output=/home/tbellagio/scratch/pang/sv_panel/syri/logs/syri_Blh-1.%j.out
#SBATCH --error=/home/tbellagio/scratch/pang/sv_panel/syri/logs/syri_Blh-1.%j.err
...
ASM=/home/tbellagio/scratch/pang/sv_panel/assemblies_clean/Blh-1.fasta
BAM=/home/tbellagio/scratch/pang/sv_panel/alignment/alignments/Blh-1/Blh-1.tair10.bam
