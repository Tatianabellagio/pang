#!/bin/bash
#SBATCH --job-name=syri_Tanz-1
#SBATCH --output=/home/tbellagio/scratch/pang/sv_panel/syri/logs/syri_Tanz-1.%j.out
#SBATCH --error=/home/tbellagio/scratch/pang/sv_panel/syri/logs/syri_Tanz-1.%j.err
...
ASM=/home/tbellagio/scratch/pang/sv_panel/assemblies_clean/Tanz-1.fasta
BAM=/home/tbellagio/scratch/pang/sv_panel/alignment/alignments/Tanz-1/Tanz-1.tair10.bam
