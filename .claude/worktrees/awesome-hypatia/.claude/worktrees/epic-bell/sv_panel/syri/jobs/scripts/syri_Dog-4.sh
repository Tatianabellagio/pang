#!/bin/bash
#SBATCH --job-name=syri_Dog-4
#SBATCH --output=/home/tbellagio/scratch/pang/sv_panel/syri/logs/syri_Dog-4.%j.out
#SBATCH --error=/home/tbellagio/scratch/pang/sv_panel/syri/logs/syri_Dog-4.%j.err
...
ASM=/home/tbellagio/scratch/pang/sv_panel/assemblies_clean/Dog-4.fasta
BAM=/home/tbellagio/scratch/pang/sv_panel/alignment/alignments/Dog-4/Dog-4.tair10.bam
