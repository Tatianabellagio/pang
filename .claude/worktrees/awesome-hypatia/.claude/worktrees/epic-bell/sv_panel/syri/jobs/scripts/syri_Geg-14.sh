#!/bin/bash
#SBATCH --job-name=syri_Geg-14
#SBATCH --output=/home/tbellagio/scratch/pang/sv_panel/syri/logs/syri_Geg-14.%j.out
#SBATCH --error=/home/tbellagio/scratch/pang/sv_panel/syri/logs/syri_Geg-14.%j.err
...
ASM=/home/tbellagio/scratch/pang/sv_panel/assemblies_clean/Geg-14.fasta
BAM=/home/tbellagio/scratch/pang/sv_panel/alignment/alignments/Geg-14/Geg-14.tair10.bam
