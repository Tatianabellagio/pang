#!/bin/bash
#SBATCH --job-name=syri_Bay-0
#SBATCH --output=/home/tbellagio/scratch/pang/sv_panel/syri/logs/syri_Bay-0.%j.out
#SBATCH --error=/home/tbellagio/scratch/pang/sv_panel/syri/logs/syri_Bay-0.%j.err
...
ASM=/home/tbellagio/scratch/pang/sv_panel/assemblies_clean/Bay-0.fasta
BAM=/home/tbellagio/scratch/pang/sv_panel/alignment/alignments/Bay-0/Bay-0.tair10.bam
