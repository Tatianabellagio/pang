#!/bin/bash
#SBATCH --job-name=syri_Abd-0
#SBATCH --output=/home/tbellagio/scratch/pang/sv_panel/syri/logs/syri_Abd-0.%j.out
#SBATCH --error=/home/tbellagio/scratch/pang/sv_panel/syri/logs/syri_Abd-0.%j.err
