#!/bin/bash
#SBATCH --job-name=syri_Elh-2
#SBATCH --output=/home/tbellagio/scratch/pang/sv_panel/syri/logs/syri_Elh-2.%j.out
#SBATCH --error=/home/tbellagio/scratch/pang/sv_panel/syri/logs/syri_Elh-2.%j.err
...
ASM=/home/tbellagio/scratch/pang/sv_panel/assemblies_clean/Elh-2.fasta
BAM=/home/tbellagio/scratch/pang/sv_panel/alignment/alignments/Elh-2/Elh-2.tair10.bam
