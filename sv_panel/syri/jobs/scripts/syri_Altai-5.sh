#!/bin/bash
#SBATCH --job-name=syri_Altai-5
#SBATCH --output=/home/tbellagio/scratch/pang/sv_panel/syri/logs/syri_Altai-5.%j.out
#SBATCH --error=/home/tbellagio/scratch/pang/sv_panel/syri/logs/syri_Altai-5.%j.err
...
ASM=/home/tbellagio/scratch/pang/sv_panel/assemblies_clean/Altai-5.fasta
BAM=/home/tbellagio/scratch/pang/sv_panel/alignment/alignments/Altai-5/Altai-5.tair10.bam
