#!/bin/bash
#SBATCH --job-name=syri_Anz-0
#SBATCH --output=/home/tbellagio/scratch/pang/sv_panel/syri/logs/syri_Anz-0.%j.out
#SBATCH --error=/home/tbellagio/scratch/pang/sv_panel/syri/logs/syri_Anz-0.%j.err
...
ASM=/home/tbellagio/scratch/pang/sv_panel/assemblies_clean/Anz-0.fasta
BAM=/home/tbellagio/scratch/pang/sv_panel/alignment/alignments/Anz-0/Anz-0.tair10.bam
