#!/bin/bash
#SBATCH --job-name=syri_Valsi-1
#SBATCH --output=/home/tbellagio/scratch/pang/sv_panel/syri/logs/syri_Valsi-1.%j.out
#SBATCH --error=/home/tbellagio/scratch/pang/sv_panel/syri/logs/syri_Valsi-1.%j.err
...
ASM=/home/tbellagio/scratch/pang/sv_panel/assemblies_clean/Valsi-1.fasta
BAM=/home/tbellagio/scratch/pang/sv_panel/alignment/alignments/Valsi-1/Valsi-1.tair10.bam
