#!/bin/bash
#SBATCH --job-name=syri_Pyl-1
#SBATCH --output=/home/tbellagio/scratch/pang/sv_panel/syri/logs/syri_Pyl-1.%j.out
#SBATCH --error=/home/tbellagio/scratch/pang/sv_panel/syri/logs/syri_Pyl-1.%j.err
...
ASM=/home/tbellagio/scratch/pang/sv_panel/assemblies_clean/Pyl-1.fasta
BAM=/home/tbellagio/scratch/pang/sv_panel/alignment/alignments/Pyl-1/Pyl-1.tair10.bam
