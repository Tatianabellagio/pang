#!/bin/bash
#SBATCH --job-name=syri_Co-4
#SBATCH --output=/home/tbellagio/scratch/pang/sv_panel/syri/logs/syri_Co-4.%j.out
#SBATCH --error=/home/tbellagio/scratch/pang/sv_panel/syri/logs/syri_Co-4.%j.err
...
ASM=/home/tbellagio/scratch/pang/sv_panel/assemblies_clean/Co-4.fasta
BAM=/home/tbellagio/scratch/pang/sv_panel/alignment/alignments/Co-4/Co-4.tair10.bam
